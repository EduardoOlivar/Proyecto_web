        ...
        <main className="contenedor-principal">
              ...
              <div>
                {preguntas.map((item, j) => (
                  ...
                  >
                    ...
                    >
                      <Typography>
                        {item.numeroPregunta}. {item.titulo}
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      {DatosPreguntas.preguntas[j].opciones.map(
                        (respuesta, i) => (
                          <Typography {...markCorrectOrNot(item, i, j)}>
                            ...
                            >
                              ...
                              <InlineMath math={respuesta.textoRespuesta} />
                            </label>
                          </Typography>
                        )
                      )}
          ...
          <div className="row ">
            <div className="col-10">
              <button
                onClick={() => (window.location.href = "./Pregunta")}
                type="button"
      ...
      <div className="contenedor-principal position-relative ">
        <div className="contenedor-pregunta">
          ...
          <Box className="mt-3 mb-3">
            <LinearProgress
              variant="determinate"
              value={((preguntaActual + 1) * 100) / preguntas.length}
            />
          </Box>
          <h3 className="enunciado-pregunta mb-3">
