...
import ModificarEnsayo from "../modificar/ModificarEnsayo";
import AñadirPreguntas from "../modificar/AñadirPreguntas";
import AdministrarPreguntas from "../modificar/AdministrarPreguntas";
...
function Menu() {
  ...
  const [showModificarEnsayo, setShowModificarEnsayo] = useState(false)
          ...
          <div className="sidebar " >
            ...
            <motion.li whileHover={{ scale: 1.02 }}
              ...
              <motion.li whileHover={{ scale: 1.02 }}
                ...
                <motion.li whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    transition={{ duration: 0.15 }}><a className={showModificarEnsayo ? "active": ""} href="#" onClick={() =>handleSidebar("modificar")  }>Administrar Preguntas</a></motion.li>
              <motion.li whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
            ...
            {!showCrearEnsayo && !showhistorial  && !showModificarEnsayo && (
