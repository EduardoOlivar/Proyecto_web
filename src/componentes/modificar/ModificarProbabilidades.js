...
class ModificarProbabilidades extends React.Component {
  state = {
    form: {
      id: "",
      question: "",
      ...
      <React.Fragment>
        <div>
          ...
          <div className="container">
            <h2 className="mt-3">
              Modificar pregunta de Probabilidad y Estadística{" "}
            </h2>
...
export default ModificarProbabilidades;
